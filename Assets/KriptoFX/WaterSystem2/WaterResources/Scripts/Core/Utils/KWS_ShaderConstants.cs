...
namespace KWS
{
    internal static class KWS_ShaderConstants
    {
        ...
        public static class ShaderNames
        {
            ...
            public static readonly string WaterCustomMeshShaderName                    = "Hidden/KriptoFX/KWS/WaterCustomMesh";
            public static readonly string WaterZoneInstanceShaderName        = "Hidden/KriptoFX/KWS/WaterZoneInstance";
            ...
            public static readonly string WaterPrePassCustomMeshShaderName   = "Hidden/KriptoFX/KWS/WaterPrePassCustomMesh";
            public static readonly string WaterPrePassZoneInstanceShaderName = "Hidden/KriptoFX/KWS/WaterPrePassZoneInstance";
            ...
            public static readonly string BakedSplashParticlesShaderName               = "KriptoFX/KWS2/SplashParticles";
        }
        ...
        public static class ConstantWaterParams
        {
            ...
            public static readonly int KWS_RenderOcean    = Shader.PropertyToID("KWS_RenderOcean");
            ...
            public static readonly int KWS_OceanTimeScale = Shader.PropertyToID("KWS_OceanTimeScale");
            ...
            public static readonly int KWS_WavesDomainSizesInv    = Shader.PropertyToID("KWS_WavesDomainSizesInv");
            public static readonly int KWS_WavesDomainScaledSizes = Shader.PropertyToID("KWS_WavesDomainScaledSizes");
            public static readonly int KWS_WavesDomainScaledSizesInv = Shader.PropertyToID("KWS_WavesDomainScaledSizesInv");
            
            public static readonly int KWS_WavesDomainVisibleArea       = Shader.PropertyToID("KWS_WavesDomainVisibleArea");
            public static readonly int KWS_WavesDomainVisibleAreaInv    = Shader.PropertyToID("KWS_WavesDomainVisibleAreaInv");
            public static readonly int KWS_WavesDomainScaledVisibleArea = Shader.PropertyToID("KWS_WavesDomainScaledVisibleArea");
            public static readonly int KWS_WavesDomainScaledVisibleAreaInv = Shader.PropertyToID("KWS_WavesDomainScaledVisibleAreaInv");
            
            public static readonly int KWS_WavesDomainHeightScales      = Shader.PropertyToID("KWS_WavesDomainHeightScales");
            ...
            public static readonly int KWS_UseCausticDispersion         = Shader.PropertyToID("KWS_UseCausticDispersion");
            public static readonly int KWS_DisableCausticInShadow         = Shader.PropertyToID("KWS_DisableCausticInShadow");
            ...
            public static readonly int KWS_OceanRainDropsIntensity    = Shader.PropertyToID("KWS_OceanRainDropsIntensity");
        }

        public static class DynamicWaterParams
        {
            public static readonly int KWS_WaterLevel          = Shader.PropertyToID("KWS_WaterLevel");
            ...
            public static readonly int KWS_CameraUp            = Shader.PropertyToID("KWS_CameraUp");
            public static readonly int KWS_CameraRight         = Shader.PropertyToID("KWS_CameraRight");
            public static readonly int KWS_WorldSpaceCameraPos = Shader.PropertyToID("KWS_WorldSpaceCameraPos");
            
            public static readonly int KWS_IsEditorCamera            = Shader.PropertyToID("KWS_IsEditorCamera");
        ...
        public static class MaskPassID
        {
            ...
            public static readonly int KWS_WaterClipMaskDepthFrontRT = Shader.PropertyToID("KWS_WaterClipMaskDepthFrontRT");
            public static readonly int KWS_WaterClipMaskDepthBackRT  = Shader.PropertyToID("KWS_WaterClipMaskDepthBackRT");
            public static readonly int KWS_WaterClipMaskRT           = Shader.PropertyToID("KWS_WaterClipMaskRT");
            ...
            public static readonly int KWS_WaterClipMask_RTHandleScale = Shader.PropertyToID("KWS_WaterClipMask_RTHandleScale");
        }
        ...
        public static class WaterKeywords
        {
            ...
            public static readonly GlobalKeyword GlobalKeyword_KWS_USE_OCEAN_RENDERING  = GlobalKeyword.Create("KWS_USE_OCEAN_RENDERING");
            ...
            public static readonly GlobalKeyword GlobalKeyword_KWS_USE_COLORED_DYNAMIC_WAVES = GlobalKeyword.Create("KWS_USE_COLORED_DYNAMIC_WAVES");
            ...
            public static readonly GlobalKeyword GlobalKeyword_KWS_USE_VOLUMETRIC_DIR_CAUSTIC  = GlobalKeyword.Create("KWS_USE_VOLUMETRIC_DIR_CAUSTIC");
            public static readonly GlobalKeyword GlobalKeyword_KWS_USE_VOLUMETRIC_FULL_CAUSTIC = GlobalKeyword.Create("KWS_USE_VOLUMETRIC_FULL_CAUSTIC");
            ...
            public static readonly GlobalKeyword GlobalKeyword_KWS_USE_CLIP_MASKING = GlobalKeyword.Create("KWS_USE_CLIP_MASKING");
            ...
            public static readonly string KWS_IS_CAMERA_PARTIAL_UNDERWATER = "KWS_IS_CAMERA_PARTIAL_UNDERWATER";
