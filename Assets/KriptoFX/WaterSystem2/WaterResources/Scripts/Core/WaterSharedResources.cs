...
namespace KWS
{
    public class WaterSharedResources
    {
        ...
        internal static Texture2D KWS_PerlinNoise;
        internal static Texture2D KWS_RainMap;
     ...
     //   public static RTHandle WaterMotionVectors       { get; internal set; }
        ...
        public static RTHandle WaterClipMaskDepthFront    { get; internal set; }
        public static RTHandle WaterClipMaskDepthBack     { get; internal set; }
        public static RTHandle WaterClipMask { get; internal set; }
        public static RTHandle WaterClipMaskDepth { get; internal set; }
        ...
        public static RTHandle FftWavesDisplacementPrev { get; internal set; }
