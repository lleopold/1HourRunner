...
namespace KWS
{
    ...
    public class WaterQualityLevelSettings
    {
        ...
        public DynamicWavesMapResolutionEnum DynamicWavesMapResolution = DynamicWavesMapResolutionEnum.High;
        ...
        public VolumetricLightCausticModeEnum       VolumetricLightCausticMode = VolumetricLightCausticModeEnum.DirLightOnly;


        //Caustic settings
        public bool                                UseCausticEffect                = true;
        public CausticTextureResolutionQualityEnum OceanCausticTextureResolutionQuality = CausticTextureResolutionQualityEnum.High;
        public bool                                UseOceanCausticHighQualityFiltering  = false;
        public bool                                UseOceanCausticDispersion            = true;
        


        //Underwater settings
        public bool UseUnderwaterEffect           = true;
        public bool DisableWaterDropsInScene = false;
        ...
        //Rendering settings
        public int WaterTransparentSortingPriority = -2;
        ...
        public enum DynamicWavesMapResolutionEnum
        {   
            Low   = 256,
            High  = 512,
            Ultra = 1024,
        ...
        public enum VolumetricLightCausticModeEnum
        {
            DirLightOnly,
            AllLights,
            Off
