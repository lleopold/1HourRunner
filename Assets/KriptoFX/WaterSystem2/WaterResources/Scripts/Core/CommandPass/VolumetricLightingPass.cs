    ...
    internal class VolumetricLightingPass : WaterPass
    {
        ...
        internal class VolumetricData : KW_Extensions.ICacheCamera
        {
            ...
            internal void InitializeSurfaceLightTextures()
            {
                ...
                VolumetricLightAdditionalDataRT = KWS_CoreUtils.RTHandleAllocVR(_surfaceLightResolution.x, _surfaceLightResolution.y, name: "_volumeLightAdditionalDataRT", colorFormat: KWS_CoreUtils.GetSafeR8G8B8A8_UNorm());
                ...
                VolumetricLightAdditionalBlured = KWS_CoreUtils.RTHandleAllocVR(_surfaceLightResolution.x, _surfaceLightResolution.y, name: "_volumeLightAdditionalDataRTBlured", colorFormat: KWS_CoreUtils.GetSafeR8G8B8A8_UNorm());
        ...
        private void ComputeSurfaceLighting(WaterPassContext waterContext)
        {
            ...
            waterContext.cmd.SetGlobalFloat("_DisableBlackColorPropagation", 1);
            data.PyramidBlur_AdditionalLight.ComputeSeparableBlur(1, additionalDataRT, data.VolumetricLightAdditionalBlured, waterContext.cmd, additionalDataRT.rt.width, additionalDataRT.rt.height);
            data.PyramidBlur_SurfaceLight.ComputeSeparableBlur(1, surfaceRT, data.VolumetricLightSurfaceRTBlured, waterContext.cmd, additionalDataRT.rt.width, additionalDataRT.rt.height);
