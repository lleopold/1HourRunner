    ...
    internal abstract class WaterPass : ScriptableRenderPass
    {
        ...
        public static UnityEngine.Rendering.RTHandle dummyRT
        {
            get
            {
                ...
                return (_dummyRT = UnityEngine.Rendering.RTHandles.Alloc(1, 1, colorFormat: KWS_CoreUtils.GetSafeR8G8B8A8_UNorm()));
            }
        }
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameContext)
        {
            ...
            int count     = lightData.additionalLightsCount;
            Shader.SetGlobalInteger("KWS_AdditionalLightsCount", count);
