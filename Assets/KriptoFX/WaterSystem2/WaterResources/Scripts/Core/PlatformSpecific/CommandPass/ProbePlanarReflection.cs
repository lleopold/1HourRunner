...
namespace KWS
{
    internal class ProbePlanarReflection: WaterPass
    {
        ...
        public void RenderPlanar(Camera currentCamera)
        {
            ...
            _probeTransform.position = new Vector3(cameraPos.x, WaterSystem.Instance.WaterLevel, cameraPos.z);
        ...
        void UpdateProbeSettings()
        {
            ...
            _probe.SetFrameSetting(FrameSettingsField.CustomPass,      false);
