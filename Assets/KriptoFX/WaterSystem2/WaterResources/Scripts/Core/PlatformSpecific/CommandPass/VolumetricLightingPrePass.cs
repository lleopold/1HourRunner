...
namespace KWS
{
    internal class VolumetricLightingPrePass: WaterPass
    {
        ...
        ComputeBuffer                dirLightShadowParamsBuffer;
        ...
        void SetDefaultBuffers()
        {
            ...
            KWS_CoreUtils.SetFallbackBuffer<DirLightShadowParams>(ref dirLightShadowParamsBuffer, LightsID.KWS_DirLightShadowParams);
        }
        ...
        public override void Release()
        {
            ...
            KWS_CoreUtils.ReleaseComputeBuffers(dirLightDataBuffer, pointLightDataBuffer, shadowPointLightDataBuffer, spotLightDataBuffer, shadowSpotLightDataBuffer, dirLightShadowParamsBuffer);
            dirLightDataBuffer = pointLightDataBuffer = shadowPointLightDataBuffer = spotLightDataBuffer = shadowSpotLightDataBuffer = dirLightShadowParamsBuffer = null;
