...
namespace KWS
{
    internal class PlanarReflectionPass : WaterPass
    {
        ...
        void RenderPlanar(Camera currentCamera, ScriptableRenderContext context)
        {
            ...
            pos.y = WaterSystem.Instance.WaterLevel;
            
            if (isStereo)
            {
                ReflectionUtils.RenderPlanarReflection(currentCamera, context, pos, _reflectionCamera, _reflectionCameraTransform, _planarLeftRT, true, Camera.StereoscopicEye.Left);
                ReflectionUtils.RenderPlanarReflection(currentCamera, context, pos, _reflectionCamera, _reflectionCameraTransform, _planarRightRT,             true,          Camera.StereoscopicEye.Right);
            ...
            {
                ReflectionUtils.RenderPlanarReflection(currentCamera, context, pos, _reflectionCamera, _reflectionCameraTransform, _planarRT, false);
            }
