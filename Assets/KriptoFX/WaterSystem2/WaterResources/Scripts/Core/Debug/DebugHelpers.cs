...
namespace KWS
{
    internal static class DebugHelpers
    {
        ...
        public static void RequestBuoyancy()
        {
            ...
            var waterPivot   = WaterSystem.Instance.WaterLevel;
            ...
            for (int x = -sizeX; x < sizeX; x++)
            {
                ...
                {
                    worldPos.Add(new Vector3(x, waterPivot, z) * 0.5f);
                    idx++;
                }
            }
        ...
        public static void DebugQuadtree(KWS_Ocean waterInstance)
        {
            var quadTreeInstance = OceanRenderPass._meshQuadTree.Instances[Camera.main];
