...
namespace RayFireEditor
{
    ...
    public class RayfireDustEditor : Editor
    {
        ...
        const int   ems_rot_min      = 0;
        const int   ems_rot_max      = 360;
        ...
        private void OnEnable()
        {
            ...
            sp_ems_rot      = serializedObject.FindProperty(nameof(dust.emission) + "." + nameof(dust.emission.rotation));
        ...
        void GUI_Emission()
        {
            ...
            if (fld_emt == true)
            {
                ...
                RFUI.IntSlider (sp_ems_rot, ems_rot_min, ems_rot_max, TextDst.gui_ems_rot);
