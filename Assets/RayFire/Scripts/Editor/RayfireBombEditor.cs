...
namespace RayFireEditor
{
    ...
    public class RayfireBombEditor : Editor
    {
        ...
        SerializedProperty sp_obst_kinematic;
        ...
        private void OnEnable()
        {
            ...
            sp_obst_kinematic  = serializedObject.FindProperty(nameof(bomb.obst_kinematic));
        ...
        void GUI_Obstacles()
        {
            ...
            if (fld_obs == true)
            {
                ...
                RFUI.PropertyField (sp_obst_kinematic, TextBmb.gui_obst_kinematic);
