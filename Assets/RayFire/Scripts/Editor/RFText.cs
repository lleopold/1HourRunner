...
namespace RayFireEditor
{
    ...
    public static class TextKeys
    {
        ...
        // Man
        public const string man_fld_adv = "rf_ma"; public const string man_fld_mat = "rf_mt";
    ...
    public static class TextBld
    {
        ...
        public static readonly GUIContent gui_gizmo          = new GUIContent ("Show Plane",      "Show slicing plane.");
    ...
    public static class TextBmb
    {
        ...
        public static readonly GUIContent gui_obst_kinematic  = new GUIContent ("Kinematic",     "Use all colliders with Kinematic RigidBody as obstacles for explosion.");
    ...
    public static class TextDst
    {
        ...
        // Strings
        public const string str_avail = "     Available : ";
        public const string str_id    = "Id 0 will create unique emitter pool for every component.";
        ...
        public static readonly GUIContent gui_ems_size_min  = new GUIContent ("Size Min",              "");
        public static readonly GUIContent gui_ems_size_max  = new GUIContent ("Size Max",              "");
        public static readonly GUIContent gui_ems_rot       = new GUIContent ("Start Rotation",        "");
        public static readonly GUIContent gui_cap_mat       = new GUIContent ("      Material",        "");
        public static readonly GUIContent gui_ems_mat       = new GUIContent ("Material",              "");
        public static readonly GUIContent gui_cap_speed     = new GUIContent ("      Speed",           "");
        public static readonly GUIContent gui_dyn_speed_min = new GUIContent ("Speed Min",             "");
    ...
    public static class TextPhy
    {
        ...
        public static readonly GUIContent gui_cap_frg = new GUIContent ("  Fragments",        "");
        public static readonly GUIContent gui_phy_dmp = new GUIContent ("Damping",            "Multiplier for demolished fragments velocity.");
    }
    ...
    public static class TextMsh
    {
        ...
        public static readonly GUIContent gui_msh_cls     = new GUIContent ("Clusters",           "Amount of clusters. Fragments will be attached into one cluster mesh.");
        ...
        public static readonly GUIContent gui_msh_adv_dec = new GUIContent ("Decompose",          "Detach separated groups of triangles to separate fragments.");
        public static readonly GUIContent gui_msh_adv_cap = new GUIContent ("Input Cap",          "Cap open edges before fragment mesh.");
        public static readonly GUIContent gui_msh_adv_col = new GUIContent ("Collider",           "Fragments collider type.");
    ...
    public static class TextCls
    {
        ...
        public static readonly GUIContent gui_cls_dml   = new GUIContent ("Demolition",            "Makes lesser connected clusters after initial demolition also demolishable. ");
    ...
    public static class TextRig
    {
        ...
        public const string str_precache   = "    Fragment meshes precached.";
        public const string str_frags      = "    Fragments created: ";
        ...
        public const string str_ch_prog    = "    Runtime Caching is in progress...";
        public const string str_ch_used    = "    Fragment meshes cached.";
        ...
        public const string str_cls_coll   = "    Colliders ";
        public const string str_cls_shards = "    Shards: ";
        public const string str_integrity  = "    Integrity: ";
        public const string str_conns      = "    Connections: ";
    ...
    public static class TextSht
    {
        ...
        public static readonly GUIContent gui_tp_tetLt        = new GUIContent ("Lattice",              "");
