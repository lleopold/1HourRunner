...
namespace RayFire
{
    ...
    {
        public float off; // byOffset
        public bool  loc; // local
        public float dmg; // byDamage
        public bool  act; // byActivator
        public bool  imp; // byImpact
        public bool  con; // byConnectivity
        public bool  uny; // unyielding
        public bool  atb; // activatable
        public bool  len; // set layer
        public int   lay; // layer
        ...
        public static void ActivateRigid (RayfireRigid scr, bool connCheck = true)
        {
            ...
            if (scr.simTp == SimType.Kinematic)
            {
                ...
                if (scr.physics.rec == true)
                {
                    ...
                    // Create copy
                    GameObject inst = Object.Instantiate (scr.gameObject);
