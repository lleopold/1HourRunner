...
namespace RayFire
{
    ...
    {
        public bool  en;  // enable
        public float max; // maxDamage
        public float cur; // currentDamage
        public bool  col; // collect
        public float mlt; // multiplier
        public bool  shr; // toShards
